...
#define TIMER0OUTCOMPARE_INT		9
#define TIMER_NUM_INTERRUPTS		10
#else
#define TIMER_NUM_INTERRUPTS		10
#endif

//Timer 0 Modes of Operation. see Table 14-8. Waveform Generation Mode Bit Description
...
typedef struct {
	uint16_t ovf_count;
	uint16_t compA_count;
	uint16_t compB_count;
	uint8_t  compA;
	uint8_t  compB;
} Timer0_t;
