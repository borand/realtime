...
// Created		: 11/22/2000
// Revised		: 06/09/2003
// Revised      : 11/09/2009 - Andrzej Borowiec, adapted to Arduino mega328P
// Version		: 1.3
...
//#else
	...
	UCSR0B = _BV(TXEN0) | _BV(RXEN0) | _BV(RXCIE0) | _BV(TXCIE0); /* tx/rx enable, rx complete intr */
//#endif
...
void uartSetBaudRate(u32 baudrate)
{
	...
	UBRR0L = (F_CPU / (8 * baudrate)) - 1;  /* 9600 Bd */
	sei();
}
...
#endif
{
	...
	if(uartBufferedTx)
	{
		...
		if(uartTxBuffer.datalength)
		{
			...
			UDR0 =  bufferGetFromFront(&uartTxBuffer);
...
// UART_INTERRUPT_HANDLER(SIG_UART_RECV) //- Modified 2009.09.10
